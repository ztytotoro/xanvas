var zovas = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    function getTargetItem(x, y, items) { }
    function moveItem(dx, dy, item) { }
    var OrderType;
    (function (OrderType) {
        OrderType[OrderType["Top"] = 0] = "Top";
        OrderType[OrderType["Up"] = 1] = "Up";
        OrderType[OrderType["Down"] = 2] = "Down";
        OrderType[OrderType["Bottom"] = 3] = "Bottom";
    })(OrderType || (OrderType = {}));
    function orderItem(type, currentIndex, items) { }
    function invokeCommand(item, command) { }
