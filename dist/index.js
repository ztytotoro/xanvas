...
function findElement(pos, elements) {
...
class CanvasCore {
    ...
    addEventListener() {
        ...
        merge(mousedown$, mousemove$, mouseup$).pipe(map(e => {
            return {
                type: e.type,
                pos: {
                    x: e.offsetX - this.ctx.canvas.offsetLeft,
                    y: e.offsetY - this.ctx.canvas.offsetTop
                }
            };
...
export { CanvasCore, CanvasSetting, EventEnd, EventStart, ImageItem, RectItem, createElement, createEvent, initCanvas, initCanvasContext, moveEvent };
